...
#pragma warning disable SA1600 // Elements should be documented
    internal static class NativeMethods
    {
        ...
        private static extern bool InvalidateRect(IntPtr hWnd, IntPtr lpRect, bool erase);

        public static void RequestTerminalRepaint(IntPtr hwnd)
        {
            if (hwnd != IntPtr.Zero)
            {
                // Invalidate only. A synchronous UpdateWindow here can re-enter the
                // native renderer while terminal output is still being forwarded.
                _ = InvalidateRect(hwnd, IntPtr.Zero, false);
            }
        }
